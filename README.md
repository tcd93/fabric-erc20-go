...
*note: if there are problems with dependencies during development with govendor, try renaming the "vendor" folder to "_vendor", and rename it back to "vendor" when deploying chaincode.*   
---
